...
function nuevoUsuario (nombre, email, password) {
  ...
  var nuevoObjeto = {
   ...
   return nuevoObjeto;
  /* SOLO CUANDO TIENEN EL MISMO NOMBRE
  var nuevoObjeto = {
    nombre:nombre,
    email: email,
    password: password
...
function sumarLikesDeUsuario (usuario) {
  ...
  // Devuelve la suma
  // Tu código:
  // ANTE LA DUDA HAGO CONSOLE LOG Y CORRO EL TEST!!! LO VEO ARRIBA
  var acumulador = 0; // tengo que definir la variable primero
...
function agregarMetodoCalculoDescuento (producto) {
  ...
  /* producto = {
    calcularPrecioDescuento : function(){
      producto.precio * porcentajeDeDescuento
      return producto
    }
  } */
