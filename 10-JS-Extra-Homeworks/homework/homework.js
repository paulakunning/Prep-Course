...
function deObjetoAmatriz(objeto){
  ...
  // UNA FORMA ---> return Object.entries(objeto);
//OTRA FORMA:
  var array = [];
  for (const props in objeto) {
    array.push([props, objeto[props]])
     }
     return array;
  }
...
function capicua(numero){
  ...
  alReves = parseInt(alReves) // lo convierto a numero
...
// ----- filter con funcion normal
var interseccion = arreglo1.filter (function(elemento){
